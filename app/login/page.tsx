...
export default function LoginPage() {
    ...
    useEffect(() => {
        ...
        if (errorParam) {
            switch (errorParam) {
                case 'no_code':
                    setError('Authorization failed: No code received from Google');
                    break;
                case 'callback_failed':
                    setError('Authentication failed: Unable to process Google response');
                    break;
                default:
            ...
            <div className="w-full max-w-md p-8 rounded-lg bg-gray-400 bg-opacity-70">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-white text-sm text-center opacity-70">
                        Sign in with your Google account to access the panel
                    </p>
                </div>
            </div>
        </div>
