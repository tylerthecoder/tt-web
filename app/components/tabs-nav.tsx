...
import { FaListAlt, FaStickyNote, FaCalendarDay, FaList, FaFileAlt } from 'react-icons/fa';
...
export function TabsNav() {
    ...
    const tabs: { id: TabId; label: string; icon: React.ReactNode; href: string; hotkey?: string }[] = useMemo(() => ([
