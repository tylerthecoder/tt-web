...
const Project = ({ creation }: IProjectProps) => {
  return (
    <a href={creation.link} target="_blank" rel="noopener noreferrer" className="block group">
      <div
        className="
				bg-orange-950
				rounded-lg
      ...
      >
        ...
        <div className="p-6">
          <h3 className="text-xl font-bold text-white mb-2">{creation.name}</h3>
          <p className="text-orange-200 text-sm line-clamp-3">{creation.description}</p>
          <div className="mt-4 flex items-center text-orange-300 text-sm">
            <span className="inline-block">View Project →</span>
          </div>
        </div>
      </div>
    </a>
...
export default async function Projects() {
  ...
  return (
    <div className="mx-auto px-4 py-12 bg-gray-900">
